...
program KWN
	...
	open(200, file = filename,  ACTION="write", STATUS="replace")

		write(200,*) '#Time, [s], Average Radius [nm], Total precipitate density [/micron^3], Volume fraction [], Critical radius [nm], Nucleation rate [/micron^3/s], Concentration in the matrix [at %]'
		...
		WRITE(200,14) (results(1,i), i=1,8)
