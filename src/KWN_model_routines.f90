...
subroutine interface_composition(Temperature,  N_elements, N_steps, stoechiometry, &
   ...
   interface_equilibrium:   do i = 0, N_steps
    ...
    subroutine growth_precipitate(stt, N_elements, N_Steps, bins,&
                                atomic_volume, na, molar_volume, ceq_precipitate, &
                                precipitate_density, dot_precipitate_density, nucleation_rate,&
                                diffusion_coefficient, c_matrix, growth_rate_array, radius_crit )
